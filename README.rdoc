...
Removing database tables also means reducing the number of queries to fetch associations, and therefore it means helping a little bit with performance too.
